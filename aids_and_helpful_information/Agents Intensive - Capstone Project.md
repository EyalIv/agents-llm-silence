...
source: "https://www.kaggle.com/competitions/agents-intensive-capstone-project/overview"
author:
published:
created: 2025-11-28
description: "Put your course learnings into action by building an agent that solves a real-world problem or improves everyday productivity."
tags:
  - "clippings"
---
Kaggle · Community Hackathon · 3 days to go
...
1. Selecting a [track](https://www.kaggle.com/competitions/agents-intensive-capstone-project/#tracks-and-awards) (and only one track) from one of the four options. This will scope the problem/use case for your project.
	- Example: Concierge Agents
2. Formulating a problem and solution pitch to which you will build your agent. This will hone the objective of your project.
...
3. Developing and publishing the code for your agent publicly.
	- Example: Publishing the agent code to GitHub or Kaggle Notebooks.
4. Being able to articulate the value of the agent by preparing a writeup.
	- Example: This agent reduced my blog writing process by 10 hours per week
5. For bonus points, publishing a video related to the project.
6. Submitting a writeup to this competition no later than December 1, 2025 11:59AM Pacific Time. Check out " [How Do I Make A Submission section](https://www.kaggle.com/competitions/agents-intensive-capstone-project/#how-do-i-make-a-submission) " below.
...
![](https://www.kaggle.com/static/images/competitions/hackathons/winner_icons/trophy_x-large.svg)
