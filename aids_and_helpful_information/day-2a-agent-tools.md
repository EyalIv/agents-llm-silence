...
**2. Clear Docstrings**: LLMs use [[Docstring|docstrings]] to understand when and how to use tools  
...
> [!TIP] 
> בעצם מה שאנחנו רואים פה שניתן לתת ל- AGENT יכולת לכתוב וליישם קוד פייתון על כל המשתמע מכך - כלומר כח גדול.
> מעל הטיפ כתוב BP (Best Practices) 
> מתחת ניתן לראות דוגמא 
...
```
    ...
    The fee for using a platinum credit card is 2.00%.
    The transaction fee is 10.00 USD.
    The amount remaining after the fee is 490.00 USD.
    The exchange rate from USD to EUR is 0.93.
    The final converted amount is 455.70 EUR.
...
```
    ...
    enhanced_currency_agent > The total amount in INR is 103430.25.
    
    Here's the breakdown of the calculation:
    1. The transaction fee for a bank transfer is 1% of the total amount.
    2. Fee amount: 1250 USD * 0.01 = 12.5 USD.
    3. Amount remaining after deducting the fee: 1250 USD - 12.5 USD = 1237.5 USD.
    4. The exchange rate from USD to INR is 83.58.
    5. Final amount in INR: 1237.5 USD * 83.58 = 103430.25 INR.
...
```
    ...
    Generated Python Response >>  103430.25
