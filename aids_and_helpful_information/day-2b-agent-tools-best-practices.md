...
### 2.1: How [[MCP - Model Context Protocol|MCP]] Works
...
```
    ...
    image_agent > I have already provided the sample tiny image in the previous turn. Please let me know if you have any other requests.
...
**The solution:** Wrap your agent in an **`App`** with **resumability enabled**[^1]. The App adds a persistence[^2] layer that saves and restores state.
...
```
    ...
    Agent > Your order for 10 containers to Rotterdam has been approved. The order ID is ORD-10-HUMAN.
    ============================================================
...
[^1]: יכולת חידוש מופעלת

[^2]: the act of persisting or persevering; continuing or repeating behavior; "his perseveration continued to the point where it was no longer appropriate"   התמדה
